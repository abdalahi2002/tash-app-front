    ...
    <nav className="bg-gray-200 shadow shadow-gray-300 w-full px-8 md:px-auto">
      <div className="md:h-16 h-28 mx-auto md:px-4 container flex items-center justify-between flex-wrap md:flex-nowrap">
        ...
        <div className="block md:hidden">
          <button onClick={toggleMobileMenu} className="px-4 py-2 bg-indigo-500 hover:bg-indigo-600 text-gray-50 rounded-xl flex items-center gap-2">
        ...
        {/* Navigation Links */}
        <div className={`text-gray-500 order-3 w-full md:w-auto md:order-2 ${isMobileMenuOpen ? 'block' : 'hidden'} md:flex`}>
