...
export default function CreateProject() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await createproject(preparedData);
            ...
            <div className="max-w-md mx-auto">
              <div className="flex items-center space-x-5">
                ...
                <div className="block pl-2 font-semibold text-xl self-start text-gray-500">
                  ...
                  <p className="text-sm text-gray-500 font-normal leading-relaxed">hhh</p>
                </div>
              </div>
                ...
                <div className="py-8 text-base leading-6 space-y-4 text-gray-500 sm:text-lg sm:leading-7">
                  <div className="flex flex-col">
                   ...
                   <div className="flex flex-col">
                        ...
                        <input name="email" onChange={handleChange} type="email" className="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600" required/>
                    </div>
